      ...
      <div className="container-tight text-center">
        ...
        <Reveal delay={0.1}>
          <p className="font-display text-2xl leading-relaxed text-cream/90 md:text-3xl" style={{ fontFamily: "'Noto Serif Devanagari', 'Tiro Devanagari Hindi', serif", lineHeight: "1.6" }}>
            जब हम जीवन की नई यात्रा की शुरुआत करने जा रहे हैं, हम अपने जीवन में आप जैसे सुंदर लोगों के होने के लिए अत्यंत आभारी हैं। आपकी उपस्थिति हमारे लिए सर्वोपरि है, और हमारे सगाई समारोह में आपकी गरिमामयी उपस्थिति हमारे लिए अत्यंत सम्मान की बात होगी। कृपया अपना स्नेह और आशीर्वाद देकर हमारे इस नए सफर की एक सुंदर शुरुआत करें।
          </p>
        </Reveal>
        <Reveal delay={0.2}>
