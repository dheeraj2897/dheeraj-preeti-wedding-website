...
const BUBBLE_DATA: BubbleItem[] = [
  ...
  },
  {
    id: 7,
    type: "bride",
    src: "/images/bubble-gallery/uploaded-7-final.jpg",
    fallback: "/images/bubble-gallery/uploaded-7-final.jpg",
    label: "Warm Affection",
    caption: "Mothers' Warm Smiles",
    description: "Mothers standing close, smiling warmly in beautiful traditional attire, showering us with their unconditional love and blessings.",
  ...
  },
  {
    ...
    label: "Warm Blessings",
    caption: "Dheeraj's Parents",
    description: "Dheeraj's loving parents sharing a beautiful moment at the historic Ellora Caves. Their guidance and affection pave our way forward.",
              ...
              <div className="flex flex-col overflow-hidden rounded-[2.2rem] md:flex-row">
                ...
                <div className="relative aspect-[4/5] w-full bg-[#1c0008]/40 md:aspect-square md:w-[48%]">
                  <Image
                    ...
                    className="object-cover"
                    style={{ objectPosition: selectedBubble.objectPosition || "center" }}
                    priority
                  />
